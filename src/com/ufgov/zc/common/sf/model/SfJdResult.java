...
//  public static final String RESULT_TYPE_YJS = "YJS";
  ...
  public static final String COL_RESULT_CODE = "SF_JD_RESULT_RESULT_CODE"; // 文书编号
   ...
   * 用页签展示
   */
  private List jdRecordFileLst=new ArrayList();
   ...
   *  用表格展示
   */
  private List attacheFileLst=new ArrayList();
...
public List getJdRecordFileLst() {
	return jdRecordFileLst;
}

public void setJdRecordFileLst(List jdRecordFileLst) {
	this.jdRecordFileLst = jdRecordFileLst;
}

public List getAttacheFileLst() {
	return attacheFileLst;
}
