...
class CutLinkAction extends AbstractAction {
	private FTPClientPanel frame; // 父窗体的引用对象
	 ...
	 */
	public CutLinkAction(FTPClientPanel client_Frame, String string, Icon icon) {
	...
	public void actionPerformed(ActionEvent e) {
		/*try {
			...
			if (frame.ftpClient != null ) {
				frame.ftpClient.quit();
