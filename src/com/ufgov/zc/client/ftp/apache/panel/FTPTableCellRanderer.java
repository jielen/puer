...
public class FTPTableCellRanderer extends DefaultTableCellRenderer {
	private final ImageIcon folderIcon = new ImageIcon(getClass().getResource(
			"/com/ufgov/zc/client/ftp/apache/res/folderIcon.JPG")); // 文件夹图标
	private final ImageIcon fileIcon = new ImageIcon(getClass().getResource(
			"/com/ufgov/zc/client/ftp/apache/res/fileIcon.JPG")); // 文件图标
	...
	protected void setValue(Object value) {
		if (value instanceof FileInterface) {
			...
			if (file.isDirectory()) {
				...
				} else if (file instanceof MyFtpFile) { // 如果数据为FtpFile类
					MyFtpFile ftpfile = (MyFtpFile) file;
					try {
