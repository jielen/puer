...
import com.ufgov.zc.client.jftp.gui.hostchooser.NfsHostChooser;
import com.ufgov.zc.client.jftp.gui.hostchooser.SftpHostChooser;
import com.ufgov.zc.client.jftp.gui.hostchooser.SmbHostChooser;
import com.ufgov.zc.client.jftp.gui.hostchooser.WebdavHostChooser;
import com.ufgov.zc.client.jftp.gui.tasks.AddBookmarks;
import com.ufgov.zc.client.jftp.gui.tasks.AdvancedOptions;
import com.ufgov.zc.client.jftp.gui.tasks.BookmarkItem;
import com.ufgov.zc.client.jftp.gui.tasks.BookmarkManager;
import com.ufgov.zc.client.jftp.gui.tasks.Displayer;
import com.ufgov.zc.client.jftp.gui.tasks.HttpBrowser;
import com.ufgov.zc.client.jftp.gui.tasks.HttpDownloader;
import com.ufgov.zc.client.jftp.gui.tasks.LastConnections;
import com.ufgov.zc.client.jftp.gui.tasks.ProxyChooser;
...
import com.ufgov.zc.client.jftp.tools.*;
...
public class AppMenuBar extends JMenuBar implements ActionListener
{
    ...
    */
    public AppMenuBar(JFtp jftp)
    {
        ...
        clearItems.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_2,ActionEvent.ALT_MASK));
        changelog.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_3,ActionEvent.ALT_MASK));
        readme.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_4,ActionEvent.ALT_MASK));
        todo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_5,ActionEvent.ALT_MASK));
    ...
    private void setMnemonics()
    {
        ...
        ftpCon.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,ActionEvent.CTRL_MASK));
        sftpCon.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,ActionEvent.CTRL_MASK));
