 ...
 */
package com.ufgov.zc.client.jftp.config;
...
public class Settings
{
    ...
    static
    {
       ...
       /* if(!getUseNewIcons()) {
        	...
        	iconImage = "img/ftp/server_add.png";
        	hostImage = "img/ftp/server_add.png";   
        	closeImage = "img/ftp/cancel.png";
        	infoImage = "img/ftp/information.png";  
        	listImage = "img/ftp/page_white_text.png";  

        	rmdirImage = "img/ftp/folder_delete.png";  
        	mkdirImage = "img/ftp/folder_add.png";   
        	refreshImage = "img/ftp/control_repeat.png";
        	refreshImage2 = "img/ftp/control_repeat_blue.png"; 
        	cdImage = "img/ftp/folder_explore.png"; 
        	cmdImage = "img/ftp/application_xp_terminal.png";   
        	downloadImage = "img/ftp/arrow_left.png";
        	uploadImage = "img/ftp/arrow_right.png";
        	fileImage = "img/ftp/page_white.png";
        	dirImage = "img/ftp/folder.png"; 
        	codeFileImage = "img/ftp/page_white_wrench.png";
        	textFileImage = "img/ftp/page_white_text.png";
        	execFileImage = "img/ftp/cog.png";
        	audioFileImage = "img/ftp/ipod.png";
        	videoFileImage = "img/ftp/camera.png";
        	htmlFileImage = "img/ftp/html.png";
        	zipFileImage = "img/ftp/page_white_zip.png";
        	imageFileImage = "img/ftp/image.png";
        	presentationFileImage = "img/ftp/page_white_powerpoint.png";
        	spreadsheetFileImage = "img/ftp/page_excel.png";
        	bookFileImage = "img/ftp/book.png";  
        	copyImage = "img/ftp/disk_multiple.png";   
        	openImage = "img/ftp/drive_web.png";
        	sftpImage = "img/ftp/drive_link.png";
        	nfsImage = "img/ftp/drive_network.png";
        	webdavImage = "img/ftp/house_go.png";  
        	linkImage = "img/ftp/arrow_right.png";
        	typeImage = "img/ftp/email_go.png";
        	deleteImage = "img/ftp/control_stop.png"; 
        	deleteImage2 = "img/ftp/control_stop_blue.png"; 
        	clearImage = "img/ftp/control_eject.png"; 
        	clearImage2 = "img/ftp/control_eject_blue.png"; 
        	resumeImage = "img/ftp/control_play.png";
        	resumeImage2 = "img/ftp/control_play_blue.png";
        	pauseImage = "img/ftp/control_pause.png";
        	pauseImage2 = "img/ftp/control_pause_blue.png";
        	saveImage = "img/ftp/disk.png";
        	cdUpImage = "img/ftp/arrow_up.png";
        	nextRSSImage = "img/ftp/rss_go.png";
        	helpImage = "img/ftp/help.png";
     /*   }*/
