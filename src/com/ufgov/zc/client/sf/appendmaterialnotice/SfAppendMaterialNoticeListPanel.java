...
import com.ufgov.zc.client.common.converter.sf.SfAppendMaterialNoticeToTableModelConverter;
 ...
 *
 */
public class SfAppendMaterialNoticeListPanel extends AbstractEditListBill implements ParentWindowAware {

  /**
   * 
   */
  private static final long serialVersionUID = -3527353479992331142L;

  public static final Logger logger = Logger.getLogger(SfAppendMaterialNoticeListPanel.class);

  private SfAppendMaterialNoticeListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_APPEND_MATERIAL_NOTICE";
  ...
  public SfAppendMaterialNoticeListPanel() {
    this(null);
  }

  public SfAppendMaterialNoticeListPanel(SfEntrust entrust) {
    this.entrust = entrust;
    init();
  }

  public void init() {
    sfAppendMaterialNoticeServiceDelegate = (ISfAppendMaterialNoticeServiceDelegate) ServiceFactory.create(
      ISfAppendMaterialNoticeServiceDelegate.class, "sfAppendMaterialNoticeServiceDelegate");
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        .getCurrUserId(), SfAppendMaterialNotice.TAB_ID);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfAppendMaterialNotice.TAB_ID), showingDisplays,
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(SfAppendMaterialNotice.SEARCH_ID, null, true, defaultValueMap, null);
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfAppendMaterialNotice.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              SfAppendMaterialNotice charge = (SfAppendMaterialNotice) viewList.get(row);
              if (self.getParent() instanceof JClosableTabbedPane) {
                new SfAppendMaterialNoticeDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());
              } else {
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return SfAppendMaterialNoticeToTableModelConverter.convertMainLst(self.sfAppendMaterialNoticeServiceDelegate.getMainDataLst(
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfAppendMaterialNoticeListPanel bill = new SfAppendMaterialNoticeListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfAppendMaterialNoticeToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfAppendMaterialNotice> beanList = new ArrayList<SfAppendMaterialNotice>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfAppendMaterialNotice bean = (SfAppendMaterialNotice) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfAppendMaterialNoticeDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfAppendMaterialNotice bean = (SfAppendMaterialNotice) beanList.get(i);
