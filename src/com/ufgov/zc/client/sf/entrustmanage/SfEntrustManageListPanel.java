...
import com.ufgov.zc.client.common.converter.sf.SfEntrustManageToTableModelConverter;
 ...
 *
 */
public class SfEntrustManageListPanel  extends AbstractEditListBill implements ParentWindowAware {
  /**
   * 
   */
  private static final long serialVersionUID = -5846663619525302744L;

  public static final Logger logger = Logger.getLogger(SfEntrustManageListPanel.class);

  private SfEntrustManageListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_ENTRUST_MANAGE";
  ...
  public SfEntrustManageListPanel() {
    this(null);
  }

  public SfEntrustManageListPanel(SfEntrust entrust) {
  ...
  public void init() {
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        .getCurrUserId(), SfEntrustManage.TAB_ID);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfEntrustManage.TAB_ID), showingDisplays,
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(SfEntrustManage.SEARCH_ID, null, true, defaultValueMap, null);
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfEntrustManage.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              SfEntrustManage charge = (SfEntrustManage) viewList.get(row);
              if (self.getParent() instanceof JClosableTabbedPane) {
                new SfEntrustManageDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());
              } else {
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return SfEntrustManageToTableModelConverter.convertMainLst(self.sfEntrustManageServiceDelegate.getMainDataLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfEntrustManageListPanel bill = new SfEntrustManageListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfEntrustManageToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfEntrustManage> beanList = new ArrayList<SfEntrustManage>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfEntrustManage bean = (SfEntrustManage) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfEntrustManageDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfEntrustManage bean = (SfEntrustManage) beanList.get(i);
