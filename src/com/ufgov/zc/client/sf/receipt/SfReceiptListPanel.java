...
import com.ufgov.zc.client.common.converter.sf.SfReceiptToTableModelConverter;
 ...
 *
 */
public class SfReceiptListPanel extends AbstractEditListBill implements ParentWindowAware {

  /**
   * 
   */
  private static final long serialVersionUID = -3096237345673109243L;

  public static final Logger logger = Logger.getLogger(SfReceiptListPanel.class);

  private SfReceiptListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_RECEIPT";
  ...
  public SfReceiptListPanel() {
    this(null);
  }

  public SfReceiptListPanel(SfEntrust entrust) {
  ...
  void init() {
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        .getCurrUserId(), SfReceipt.TAB_ID);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfReceipt.TAB_ID), showingDisplays,
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(SfReceipt.SEARCH_ID, null, true, defaultValueMap, null);
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfReceipt.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              SfReceipt charge = (SfReceipt) viewList.get(row);
              if (self.getParent() instanceof JClosableTabbedPane) {
                new SfReceiptDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());
              } else {
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return SfReceiptToTableModelConverter.convertMainLst(self.sfReceiptServiceDelegate.getMainDataLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfReceiptListPanel bill = new SfReceiptListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfReceiptToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfReceipt> beanList = new ArrayList<SfReceipt>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfReceipt bean = (SfReceipt) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfReceiptDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfReceipt bean = (SfReceipt) beanList.get(i);
