...
import com.ufgov.zc.client.common.converter.sf.SfSjGroupToTableModelConverter;
import com.ufgov.zc.client.common.converter.sf.SfSjUnitToTableModelConverter;
 ...
 *
 */
public class SfSjUnitListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(SfSjUnitListPanel.class);

  private SfSjUnitListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_SJ_UNIT";
  ...
  public SfSjUnitListPanel() { 
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        List<SearchCondition> needDisplaySearchConditonList = SearchConditionUtil.getNeedDisplaySearchConditonList(WorkEnv.getInstance().getCurrUserId(), SfSjUnit.TAB_ID);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfSjUnit.TAB_ID), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfSjUnit.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfSjUnitDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return SfSjUnitToTableModelConverter.convertToTableModel(self.zcEbBaseServiceDelegate.queryDataForList("com.ufgov.zc.server.sf.dao.SfSjUnitMapper.selectMainDataLst", elementConditionDto, requestMeta));
        }
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfSjUnitListPanel bill = new SfSjUnitListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfMajorToTableModelConverter.convertToTableModel(beanList));

  }

  public List getCheckedList() {

    List<SfSjUnit> beanList = new ArrayList<SfSjUnit>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfSjUnit bean = (SfSjUnit) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfSjUnitDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfSjUnit bean = (SfSjUnit) beanList.get(i);
