...
import com.ufgov.zc.client.common.converter.sf.SfJdDocTypeToTableModelConverter;
...
public class SfJdDocTypeListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(SfJdDocTypeListPanel.class);

  private SfJdDocTypeListPanel self = this;
  ...
  public SfJdDocTypeListPanel() {
    sfJdDocTypeServiceDelegate = (ISfJdDocTypeServiceDelegate) ServiceFactory.create(ISfJdDocTypeServiceDelegate.class,

    "sfJdDocTypeServiceDelegate");
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        .getCurrUserId(), SfJdDocType.TAB_ID);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfJdDocType.TAB_ID), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfJdDocType.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfJdDocTypeDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return SfJdDocTypeToTableModelConverter.convertMainLst(self.sfJdDocTypeServiceDelegate.getMainDataLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfJdDocTypeListPanel bill = new SfJdDocTypeListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfJdDocTypeToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfJdDocType> beanList = new ArrayList<SfJdDocType>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfJdDocType bean = (SfJdDocType) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfJdDocTypeDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfJdDocType bean = (SfJdDocType) beanList.get(i);
