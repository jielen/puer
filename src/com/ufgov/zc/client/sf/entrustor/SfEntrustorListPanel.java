...
import com.ufgov.zc.client.common.converter.sf.SfEntrustorToTableModelConverter;
 ...
 *
 */
public class SfEntrustorListPanel extends AbstractEditListBill implements ParentWindowAware {

  /**
   * 
   */
  private static final long serialVersionUID = 3956986884404400936L;

  public static final Logger logger = Logger.getLogger(SfEntrustorListPanel.class);

  private SfEntrustorListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_ENTRUSTOR";
  ...
  public SfEntrustorListPanel() {
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        .getCurrUserId(), SfEntrustor.TAB_ID_ENTRUSTOR);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfEntrustor.TAB_ID_ENTRUSTOR), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfEntrustor.TAB_ID_ENTRUSTOR);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfEntrustorDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return SfEntrustorToTableModelConverter.convertToTableModel(self.sfEntrutstorServiceDelegate.getEntrustorLst(elementConditionDto,
            requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfEntrustorListPanel bill = new SfEntrustorListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfEntrustorToTableModelConverter.convertToTableModel(beanList));

  }

  public List getCheckedList() {

    List<SfMajor> beanList = new ArrayList<SfMajor>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfMajor bean = (SfMajor) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfEntrustorDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfMajor bean = (SfMajor) beanList.get(i);
