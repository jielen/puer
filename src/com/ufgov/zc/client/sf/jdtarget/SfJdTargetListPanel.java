...
import com.ufgov.zc.client.common.converter.sf.SfJdTargetToTableModelConverter;
 ...
 *
 */
public class SfJdTargetListPanel  extends AbstractEditListBill implements ParentWindowAware {

  /**
   * 
   */
  private static final long serialVersionUID = 8453824405408550160L;

  public static final Logger logger = Logger.getLogger(SfJdTargetListPanel.class);

  private SfJdTargetListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_JD_TARGET";
...
public SfJdTargetListPanel(){
  ...
  UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
    ...
    public List<SearchCondition> execute() throws Exception {
      ...
      .getCurrUserId(), SfJdTarget.TAB_ID_JD_TARGET);
...
private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
  ...
  return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfJdTarget.TAB_ID_JD_TARGET), showingDisplays,
...
private final class DataDisplay extends MultiDataDisplay {
  ...
  boolean showConditionArea) {
    ...
    super(displays, showingDisplays, conditionArea, showConditionArea, SfJdTarget.TAB_ID_JD_TARGET);
      ...
      table.addMouseListener(new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
          ...
          if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
            ...
            new SfJdTargetDialog(self, viewList, row, tabStatus);
  ...
  protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
      ...
      public TableModel execute() throws Exception {
        return SfJdTargetToTableModelConverter.convertToTableModel(self.sfJdTargetServiceDelegate.getJdTargetLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfJdTargetListPanel bill = new SfJdTargetListPanel();
...
//    toolBar.add(traceDataButton);
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfJdTargetToTableModelConverter.convertToTableModel(beanList));
  ...
  private void doAdd() {
    ...
    new SfJdTargetDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
