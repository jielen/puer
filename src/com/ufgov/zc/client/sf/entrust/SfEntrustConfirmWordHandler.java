 ...
 *
 */
public class SfEntrustConfirmWordHandler extends WordHandlerAdapter {
	  ...
	  public String getTemplateFileId() {
	    ...
	    return "sf_entrust_confirm_template";
	  }
	  ...
	  public Map<String, Object> initTemplateData(Map<String, Object> sourceMap) {
	    ...
	    dataMap.put("WTFDZ", StringUtil.freeMarkFillWordChar(entrust.getEntrustor().getAddress()));
	    dataMap.put("WTFYB", StringUtil.freeMarkFillWordChar(entrust.getEntrustor().getZip()));
...
//	    setCharges(dataMap, entrust.getJdChargeDetaillst());
	...
	private void setJdTarget(Map<String, Object> dataMap, SfJdTarget jdTarget) {
