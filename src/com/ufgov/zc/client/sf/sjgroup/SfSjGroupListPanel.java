 ...
 *
 */
public class SfSjGroupListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(SfSjGroupListPanel.class);

  private SfSjGroupListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_SJ_GROUP";
  ...
  public SfSjGroupListPanel() { 
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        List<SearchCondition> needDisplaySearchConditonList = SearchConditionUtil.getNeedDisplaySearchConditonList(WorkEnv.getInstance().getCurrUserId(), SfSjGroup.TAB_ID_SF_SJ_GROUP);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfSjGroup.TAB_ID_SF_SJ_GROUP), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfSjGroup.TAB_ID_SF_SJ_GROUP);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfSjGroupDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return SfSjGroupToTableModelConverter.convertToTableModel(self.zcEbBaseServiceDelegate.queryDataForList("com.ufgov.zc.server.sf.dao.SfSjGroupMapper.selectMainDataLst", elementConditionDto, requestMeta));
        }
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfSjGroupListPanel bill = new SfSjGroupListPanel();
  ...
  public List getCheckedList() {
    ...
    List<SfSjGroup> beanList = new ArrayList<SfSjGroup>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfSjGroup bean = (SfSjGroup) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfSjGroupDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfSjGroup bean = (SfSjGroup) beanList.get(i);
