...
import com.ufgov.zc.client.common.converter.sf.SfChargeStandardToTableModelConverter;
 ...
 *
 */
public class SfChargeStandardListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(SfChargeStandardListPanel.class);

  private SfChargeStandardListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_CHARGE_STANDARD";
  ...
  public SfChargeStandardListPanel() {
    ...
    baseDataServiceDelegate = (IBaseDataServiceDelegate) ServiceFactory.create(IBaseDataServiceDelegate.class,
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        .getCurrUserId(), SfChargeStandard.TAB_ID);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfChargeStandard.TAB_ID), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfChargeStandard.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfChargeStandardDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return SfChargeStandardToTableModelConverter.convertMainLst(self.sfChargeStandardServiceDelegate.getMainDataLst(elementConditionDto,
            requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfChargeStandardListPanel bill = new SfChargeStandardListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfChargeStandardToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfChargeStandard> beanList = new ArrayList<SfChargeStandard>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfChargeStandard bean = (SfChargeStandard) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfChargeStandardDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfChargeStandard bean = (SfChargeStandard) beanList.get(i);
