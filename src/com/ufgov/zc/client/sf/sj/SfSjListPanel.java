...
import com.ufgov.zc.client.common.converter.sf.SfSjToTableModelConverter;
...
public class SfSjListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(SfSjListPanel.class);

  private SfSjListPanel self = this;
...
//  public static final String compoId = "SF_JD_DOC_TYPE";
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfSj.TAB_ID), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfSj.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfSjDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return SfSjToTableModelConverter.convertMainLst(self.zcEbBaseServiceDelegate.queryDataForList("com.ufgov.zc.server.sf.dao.SfSjMapper.selectMainDataLst",elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfSjListPanel bill = new SfSjListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfSjToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfSj> beanList = new ArrayList<SfSj>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfSj bean = (SfSj) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfSjDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
