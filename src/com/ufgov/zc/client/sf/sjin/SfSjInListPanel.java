 ...
 *
 */
public class SfSjInListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(SfSjInListPanel.class);

  private SfSjInListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_SJ_IN";
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfSjIn.TAB_ID), showingDisplays,
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(SfSjIn.SEARCH_ID, null, false, defaultValueMap, null);
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfSjIn.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfSjInDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return SfSjInToTableModelConverter.convertMainLst(self.sfSjInServiceDelegate.getMainLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfSjInListPanel bill = new SfSjInListPanel();
  ...
  public List getCheckedList() {
    ...
    List<SfSjIn> beanList = new ArrayList<SfSjIn>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfSjIn bean = (SfSjIn) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfSjInDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfSjIn bean = (SfSjIn) beanList.get(i);
