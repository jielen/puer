...
import com.ufgov.zc.client.common.converter.sf.SfSjInToTableModelConverter;
import com.ufgov.zc.client.common.converter.sf.SfSjOutToTableModelConverter;
 ...
 *
 */
public class SfSjOutListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(SfSjOutListPanel.class);

  private SfSjOutListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_SJ_OUT";
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfSjOut.TAB_ID), showingDisplays,
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(SfSjOut.SEARCH_ID, null, false, defaultValueMap, null);
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfSjOut.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfSjOutDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return SfSjOutToTableModelConverter.convertMainLst(self.sfSjOutServiceDelegate.getMainDataLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfSjOutListPanel bill = new SfSjOutListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfSjInToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfSjOut> beanList = new ArrayList<SfSjOut>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfSjOut bean = (SfSjOut) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfSjOutDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfSjOut bean = (SfSjOut) beanList.get(i);
