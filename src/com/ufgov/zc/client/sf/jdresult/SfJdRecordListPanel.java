 ...
 *
 */
public class SfJdRecordListPanel  extends AbstractEditListBill implements ParentWindowAware {
	  /**
	   * 
	   */
	  private static final long serialVersionUID = -5846663619525302744L;

	  public static final Logger logger = Logger.getLogger(SfJdRecordListPanel.class);

	  private SfJdRecordListPanel self = this;
	  ...
	  public SfJdRecordListPanel() {
	    this(null);
	  }

	  public SfJdRecordListPanel(SfEntrust entrust) {
	          ...
	          public void mouseClicked(MouseEvent e) {
	            ...
	            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
	              ...
	              if (self.getParent() instanceof JClosableTabbedPane) {
	                new SfJdRecordDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());
	              } else {
	  ...
	  public static void main(String[] args) {
	    ...
	    SwingUtilities.invokeLater(new Runnable() {
	      ...
	      public void run() {
	        ...
	        SfJdRecordListPanel bill = new SfJdRecordListPanel();
	  ...
	  private void doAdd() {
	    ...
	    new SfJdRecordDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
