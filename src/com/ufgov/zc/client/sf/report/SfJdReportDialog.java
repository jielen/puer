 ...
 *
 */
public class SfJdReportDialog  extends GkBaseDialog {

	  /**
	   * 
	   */
	  private static final long serialVersionUID = 8087684903534439739L;
	  private SfJdReportListPanel listPanel;
	  private SfJdReportEditPanel editPanel;
	  private SfJdReportDialog self=this;


	  public SfJdReportDialog(SfJdReportListPanel listPanel, List beanList, int editingRow, String tabStatus) {

	    super(listPanel.getParentWindow(), Dialog.ModalityType.APPLICATION_MODAL);

	    this.listPanel = listPanel;

	    editPanel = new SfJdReportEditPanel(this.self, new ListCursor(beanList, editingRow), tabStatus, listPanel);
