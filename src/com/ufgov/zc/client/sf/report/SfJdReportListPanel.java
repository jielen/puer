...
import com.ufgov.zc.client.common.converter.sf.SfJdReportToTableModelConverter;
 ...
 *
 */
public class SfJdReportListPanel  extends AbstractEditListBill implements ParentWindowAware {

	  /**
	   * 
	   */
	  private static final long serialVersionUID = 1529767585832003544L;

	  public static final Logger logger = Logger.getLogger(SfJdReportListPanel.class);

	  private SfJdReportListPanel self = this;

	  private Window parentWindow;

	  public static final String compoId = "SF_JD_REPORT";
	  ...
	  public SfJdReportListPanel(SfEntrust entrust){
	    this.entrust=entrust;
	    init();
	  }
	public SfJdReportListPanel(){
	  init();
	}
	 void init(){

	   sfJdReportServiceDelegate = (ISfJdReportServiceDelegate) ServiceFactory.create(ISfJdReportServiceDelegate.class,"sfJdReportServiceDelegate");
	   ...
	   UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
	     ...
	     public List<SearchCondition> execute() throws Exception {
	       ...
	       .getCurrUserId(), SfJdReport.TAB_ID);
	...
	private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
	  ...
	  return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfJdReport.TAB_ID), showingDisplays,
	...
	private AbstractSearchConditionArea createTopConditionArea() {
	  ...
	  topSearchConditionArea = new SaveableSearchConditionArea(SfJdReport.SEARCH_ID, null, true, defaultValueMap, null);
	...
	private final class DataDisplay extends MultiDataDisplay {
	  ...
	  boolean showConditionArea) {
	    ...
	    super(displays, showingDisplays, conditionArea, showConditionArea, SfJdReport.TAB_ID);
	      ...
	      table.addMouseListener(new MouseAdapter() {
	        ...
	        public void mouseClicked(MouseEvent e) {
	          ...
	          if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
	            ...
	            SfJdReport charge=(SfJdReport) viewList.get(row);
	            if(self.getParent() instanceof JClosableTabbedPane){
	              new SfJdReportDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());
	            }else{
	  ...
	  protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
	    ...
	    UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
	      ...
	      public TableModel execute() throws Exception {
	        return SfJdReportToTableModelConverter.convertMainLst(self.sfJdReportServiceDelegate.getMainDataLst(elementConditionDto, requestMeta));
	  ...
	  public static void main(String[] args) {
	    ...
	    SwingUtilities.invokeLater(new Runnable() {
	      ...
	      public void run() {
	        ...
	        SfJdReportListPanel bill = new SfJdReportListPanel();
...
//	    toolBar.add(traceDataButton);
	  ...
	  public void refreshCurrentTabData(List beanList) {
	    ...
	    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfJdReportToTableModelConverter.convertMainLst(beanList));

	  }

	  public List getCheckedList() {

	    List<SfJdReport> beanList = new ArrayList<SfJdReport>();
	    ...
	    for (Integer checkedRow : checkedRows) {
	      ...
	      SfJdReport bean = (SfJdReport) list.get(accordDataRow);
	  ...
	  private void doAdd() {
	    ...
	    new SfJdReportDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
...
//	    new SfDataFlowDialog(compoId,null,self);
	  ...
	  private void doTrace() {
	    ...
	    for (int i = 0; i < beanList.size(); i++) {
	      ...
	      SfJdReport bean = (SfJdReport) beanList.get(i);
