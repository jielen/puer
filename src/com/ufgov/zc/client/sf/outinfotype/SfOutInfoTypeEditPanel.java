...
public class SfOutInfoTypeEditPanel extends AbstractMainSubEditPanel {
  ...
  private static String compoId = "SF_OUT_INFO_TYPE";
  ...
  protected ListCursor<SfOutInfoType> listCursor;

  private SfOutInfoType oldOutInfoType;

  public SfOutInfoTypeListPanel listPanel;

  protected SfOutInfoTypeEditPanel self = this;
  ...
  private void refreshData() {
    ...
    if (outInfoType != null && !"".equals(ZcUtil.safeString(outInfoType.getOutInfoTypeCode()))) {//列表页面双击进入

      this.pageStatus = ZcSettingConstants.PAGE_STATUS_BROWSE;

      outInfoType = sfOutInfoTypeServiceDelegate.selectByPrimaryKey(outInfoType.getOutInfoTypeCode(), this.requestMeta);
  ...
  protected void doDelete() {
    ...
    if (num == JOptionPane.YES_OPTION) {
      ...
      try {
        ...
        sfOutInfoTypeServiceDelegate.deleteByPrimaryKeyFN(outInfoType.getOutInfoTypeCode(), requestMeta);
