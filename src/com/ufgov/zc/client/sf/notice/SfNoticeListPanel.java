...
import com.ufgov.zc.client.common.converter.sf.SfNoticeToTableModelConverter;
...
public class SfNoticeListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  public static final Logger logger = Logger.getLogger(SfNoticeListPanel.class);

  private SfNoticeListPanel self = this;
...
//  public static final String compoId = "SF_JD_DOC_TYPE";
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfNotice.TAB_ID), showingDisplays,
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfNotice.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              new SfNoticeDialog(self, viewList, row, tabStatus);
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          ...
          return SfNoticeToTableModelConverter.convertMainLst(self.zcEbBaseServiceDelegate.queryDataForList("com.ufgov.zc.server.sf.dao.SfNoticeMapper.selectMainDataLst",elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfNoticeListPanel bill = new SfNoticeListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfNoticeToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfNotice> beanList = new ArrayList<SfNotice>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfNotice bean = (SfNotice) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfNoticeDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfNotice bean = (SfNotice) beanList.get(i);
