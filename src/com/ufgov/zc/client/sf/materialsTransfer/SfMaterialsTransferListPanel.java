 ...
 *
 */
public class SfMaterialsTransferListPanel extends AbstractEditListBill implements ParentWindowAware {
  /**
   * 
   */
  private static final long serialVersionUID = -5846663619525302744L;

  public static final Logger logger = Logger.getLogger(SfMaterialsTransferListPanel.class);

  private SfMaterialsTransferListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_MATERIALS_TRANSFER";
  ...
  public SfMaterialsTransferListPanel() {
    this(null);
  }

  public SfMaterialsTransferListPanel(SfEntrust entrust) {
    this.entrust = entrust;
    init();
  }

  void init() {
    sfMaterialsTransferServiceDelegate = (ISfMaterialsTransferServiceDelegate) ServiceFactory.create(ISfMaterialsTransferServiceDelegate.class,
      "sfMaterialsTransferServiceDelegate");
    ...
    UIUtilities.asyncInvoke(new DefaultInvokeHandler<List<SearchCondition>>() {
      ...
      public List<SearchCondition> execute() throws Exception {
        ...
        .getCurrUserId(), SfMaterialsTransfer.TAB_ID);
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfMaterialsTransfer.TAB_ID), showingDisplays,
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(SfMaterialsTransfer.SEARCH_ID, null, true, defaultValueMap, null);
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfMaterialsTransfer.TAB_ID);
        ...
        table.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              SfMaterialsTransfer charge = (SfMaterialsTransfer) viewList.get(row);
              if (self.getParent() instanceof JClosableTabbedPane) {
                new SfMaterialsTransferDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());
              } else {
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return SfMaterialsTransferToTableModelConverter.convertMainLst(self.sfMaterialsTransferServiceDelegate.getMainDataLst(elementConditionDto,
            requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfMaterialsTransferListPanel bill = new SfMaterialsTransferListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfMaterialsTransferToTableModelConverter.convertMainLst(beanList));

  }

  public List getCheckedList() {

    List<SfMaterialsTransfer> beanList = new ArrayList<SfMaterialsTransfer>();
    ...
    for (Integer checkedRow : checkedRows) {
      ...
      SfMaterialsTransfer bean = (SfMaterialsTransfer) list.get(accordDataRow);
  ...
  private void doAdd() {
    ...
    new SfMaterialsTransferDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfMaterialsTransfer bean = (SfMaterialsTransfer) beanList.get(i);
