 ...
 *
 */
public class SfChargeListPanel extends AbstractEditListBill implements ParentWindowAware {
  ...
  private SfChargeListPanel self = this;

  private Window parentWindow;

  public static final String compoId = "SF_CHARGE";
  ...
  public SfChargeListPanel() {
    this(null);
  }

  public SfChargeListPanel(SfEntrust entrust) {
  ...
  private AbstractDataDisplay createDataDisplay(List<TableDisplay> showingDisplays) {
    ...
    return new DataDisplay(SearchConditionUtil.getAllTableDisplay(SfCharge.TAB_ID), showingDisplays,
  ...
  private AbstractSearchConditionArea createTopConditionArea() {
    ...
    topSearchConditionArea = new SaveableSearchConditionArea(SfCharge.SEARCH_ID, null, true, defaultValueMap, null);
  ...
  private final class DataDisplay extends MultiDataDisplay {
    ...
    boolean showConditionArea) {
      ...
      super(displays, showingDisplays, conditionArea, showConditionArea, SfCharge.TAB_ID);
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
              ...
              if (self.getParent() instanceof JClosableTabbedPane) {
                new SfChargeDialog(self, viewList, row, topDataDisplay.getActiveTableDisplay().getStatus());
              } else {
    ...
    protected void handleTableDisplayActived(AbstractSearchConditionItem[] searchConditionItems, final TableDisplay tableDisplay) {
      ...
      UIUtilities.asyncInvoke(new DefaultInvokeHandler<TableModel>() {
        ...
        public TableModel execute() throws Exception {
          return SfChargeToTableModelConverter.convertMainLst(self.sfChargeServiceDelegate.getMainDataLst(elementConditionDto, requestMeta));
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        SfChargeListPanel bill = new SfChargeListPanel();
  ...
  public void refreshCurrentTabData(List beanList) {
    ...
    topDataDisplay.getActiveTableDisplay().getTable().setModel(SfChargeToTableModelConverter.convertMainLst(beanList));
  ...
  private void doAdd() {
    ...
    new SfChargeDialog(self, new ArrayList(1), -1, topDataDisplay.getActiveTableDisplay().getStatus());
  ...
  private void doTrace() {
    ...
    for (int i = 0; i < beanList.size(); i++) {
      ...
      SfCharge bean = (SfCharge) beanList.get(i);
