...
public class SfSjUnitNewFieldEditor  extends ForeignEntityFieldEditor {
  ...
  public SfSjUnitNewFieldEditor(String sqlMapSelectedId, int col, IForeignEntityHandler handler, String[] columNames, String name, String fieldName) {
  ...
  protected JComponent createEditorComponent() {
    ...
    this.handler, this.columNames, this.dialogTitle, ZcSettingConstants.FOREIGNENTITY_NEW_SF_SJ_UNIT);
