...
public class SfSjProductorNewFieldEditor extends ForeignEntityFieldEditor {
  ...
  public SfSjProductorNewFieldEditor(String sqlMapSelectedId,ElementConditionDto dto, int col, IForeignEntityHandler handler, String[] columNames, String name, String fieldName) {
  ...
  protected JComponent createEditorComponent() {
    ...
    this.handler, this.columNames, this.dialogTitle, ZcSettingConstants.FOREIGNENTITY_NEW_SF_SJ_PRODUCTOR);
