...
/**
* @ClassName: CombineData
* @Description: TCJLODO(这里用一句话描述这个类的作用)
* @date: Jan 30, 2013 9:14:03 AM
* @version: V1.0 
* @since: 1.0
...
public class CombineData {
  ...
  private ArrayList<HashMap<Integer, Integer>> rowPoss;//每行的起点

  private ArrayList<HashMap<Integer, Integer>> rowCounts;//每行的跨度
